...
$commentConst = [
    ...
    'ADMIN_COMMENT_APPROVED_MODAL_MESSAGE'   => 'Etes-vous certain(e) de vouloir approuver ce commentaire ?',
    'ADMIN_COMMENT_APPROVED_SUCCESS_MESSAGE' => 'Le commentaire a été approuvé avec succès',
    'ADMIN_COMMENT_APPROVED_ERROR_MESSAGE'   => 'Vous n\'avez pas les droits nécessaires pour approuver ce commentaire',
    'ADMIN_COMMENT_ERROR_MESSAGE'            => 'Vous n\'avez pas les droits nécessaires pour modifier/supprimer ce commentaire',
    'ADMIN_COMMENT_DELETED_MODAL_MESSAGE'    => 'Etes-vous certain(e) de vouloir supprimer ce commentaire ?',
...
$postConst = [
    ...
    'ADMIN_POST_DELETED_MODAL_MESSAGE'       => 'Etes-vous certain(e) de vouloir supprimer cet article  ?',
